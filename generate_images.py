...
flags.DEFINE_string('model', 'vdbgan_wiki-art_32_0.1_128_2019-01-11-08-41-49',
                    'The model to use to generate the images.')
...
flags.DEFINE_string('results_dir', os.path.normpath(os.path.join(cur_dir, '../../results/vdbgan')),
                    'Directory to store the results at.')
flags.DEFINE_string('generator_name', 'generator_cin',
                    'The name of the generator model to use for the image generation.')
...
def main(_):
    ...
    with graph.as_default():
        with sess.as_default():
            ...
            # output and cast to common uint8 color image
